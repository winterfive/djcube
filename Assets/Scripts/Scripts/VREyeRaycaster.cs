...
public class VREyeRaycaster : MonoBehaviour
{
    ...
    private CubeActions m_CurrentInteractible;                //The current interactive item
    private CubeActions m_LastInteractible;                   //The last interactive item


    // Utility for other classes to get the current interactive item
    public CubeActions CurrentInteractible
    {
    ...
    private void EyeRaycast()
    {
        ...
        {
            CubeActions interactible = hit.collider.GetComponent<CubeActions>(); //attempt to get the VRInteractiveItem on the hit object
